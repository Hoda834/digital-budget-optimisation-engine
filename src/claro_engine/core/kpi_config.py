...
KPI_CONFIG: List[Dict[str, Any]] = [
    ...
    {"platform": "fb", "goal": GOAL_LG, "var": "FB_LG_PURCHASES",   "kpi_label": "Purchases",        "kind": KIND_COUNT},
    # ── Instagram ──────────────────────────────────────────────────────────
    {"platform": "ig", "goal": GOAL_AW, "var": "IG_AW_REACH",       "kpi_label": "Reach",            "kind": KIND_COUNT},
    {"platform": "ig", "goal": GOAL_EN, "var": "IG_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    {"platform": "ig", "goal": GOAL_LG, "var": "IG_LG_PURCHASES",   "kpi_label": "Purchases",        "kind": KIND_COUNT},
    # ── LinkedIn ───────────────────────────────────────────────────────────
    {"platform": "li", "goal": GOAL_AW, "var": "LI_AW_REACH",       "kpi_label": "Reach",            "kind": KIND_COUNT},
    {"platform": "li", "goal": GOAL_EN, "var": "LI_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    {"platform": "yt", "goal": GOAL_EN, "var": "YT_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    {"platform": "yt", "goal": GOAL_WT, "var": "YT_WT_CLICKS",      "kpi_label": "Link Clicks",      "kind": KIND_COUNT},
    {"platform": "yt", "goal": GOAL_LG, "var": "YT_LG_LEADS",       "kpi_label": "Conversions",      "kind": KIND_COUNT},
    {"platform": "yt", "goal": GOAL_LG, "var": "YT_LG_PURCHASES",   "kpi_label": "Purchases",        "kind": KIND_COUNT},
    # ── TikTok ─────────────────────────────────────────────────────────────
    {"platform": "tt", "goal": GOAL_AW, "var": "TT_AW_VIEWS",       "kpi_label": "Video Views",      "kind": KIND_COUNT},
    {"platform": "tt", "goal": GOAL_EN, "var": "TT_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    {"platform": "tt", "goal": GOAL_LG, "var": "TT_LG_PURCHASES",   "kpi_label": "Purchases",        "kind": KIND_COUNT},
    # ── Pinterest ──────────────────────────────────────────────────────────
    ...
    {"platform": "pt", "goal": GOAL_LG, "var": "PT_LG_PURCHASES",   "kpi_label": "Checkouts",        "kind": KIND_COUNT},
    # ── X / Twitter ────────────────────────────────────────────────────────
    {"platform": "tw", "goal": GOAL_AW, "var": "TW_AW_IMPRESSION",  "kpi_label": "Impression",       "kind": KIND_COUNT},
    {"platform": "tw", "goal": GOAL_EN, "var": "TW_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    {"platform": "sn", "goal": GOAL_EN, "var": "SN_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    {"platform": "sn", "goal": GOAL_LG, "var": "SN_LG_PURCHASES",   "kpi_label": "Purchases",        "kind": KIND_COUNT},
    # ── Reddit ─────────────────────────────────────────────────────────────
    {"platform": "rd", "goal": GOAL_AW, "var": "RD_AW_IMPRESSION",  "kpi_label": "Impression",       "kind": KIND_COUNT},
    {"platform": "rd", "goal": GOAL_EN, "var": "RD_EN_ENGAGEMENT",  "kpi_label": "Engagement",       "kind": KIND_COUNT},
    ...
    # No engagement goal — Google Search has no engagement count distinct
    # from clicks.  CTR was the legacy KPI but it's a rate, which violates
    # the platform-uniform-units invariant; "engaged clicks" would just
    # equal Clicks (= WT_CLICKS), so the engagement category is simply
    # omitted for Google surfaces.
    ...
    {"platform": "go_search",  "goal": GOAL_LG, "var": "GO_SEARCH_LG_PURCHASES",   "kpi_label": "Purchases",    "kind": KIND_COUNT},
    ...
    {"platform": "go_display", "goal": GOAL_LG, "var": "GO_DISPLAY_LG_PURCHASES",   "kpi_label": "Purchases",    "kind": KIND_COUNT},
    ...
    {"platform": "go_pmax",    "goal": GOAL_LG, "var": "GO_PMAX_LG_PURCHASES",   "kpi_label": "Purchases",    "kind": KIND_COUNT},
]
